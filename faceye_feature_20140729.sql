...
--
-- Host: localhost    Database: faceye_feature
-- ------------------------------------------------------
...
INSERT INTO `security_menu` VALUES (7,'系统管理',1,8,NULL),(8,'用户管理',1,9,7),(9,'角色管理',1,10,7),(10,'资源管理',1,11,7),(11,'菜单管理',1,12,7);
...
INSERT INTO `security_menu_role` VALUES (7,1),(8,1),(9,1),(10,1),(11,1);
...
INSERT INTO `security_resource` VALUES (4,'测试','/ajax/register'),(5,'第一个','/ajax/test'),(6,'test-1','ajax/test'),(7,'tet','ss'),(8,'系统管理',''),(9,'用户管理','/security/user/home'),(10,'角色管理','/security/role/home'),(11,'资源管理','/security/resource/home'),(12,'菜单管理','/security/menu/home');
...
INSERT INTO `security_role` VALUES (1,'管理员'),(2,'用户');
...
INSERT INTO `security_role_resource` VALUES (1,8),(1,9),(1,10),(1,11),(1,12);
...
INSERT INTO `security_user` VALUES (209,0,0,0,'haipenge@gmail.com',1,'21232f297a57a5a743894a0e4a801fc3','admin'),(210,0,0,0,'test@sohu.com',1,'098f6bcd4621d373cade4e832627b4f6','test');
...
INSERT INTO `security_user_role` VALUES (1,209),(2,210);
...
-- Dump completed on 2014-07-29 13:40:04
